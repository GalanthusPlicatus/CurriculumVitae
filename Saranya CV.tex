...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Essentials
\name{Saranya Velusamy}{}
\address{\#1647/62, East End A Main Road, Jayanagar 9\textsuperscript{th} Block, Bangalore 560041, Karnataka, India}
\mobile{(+91) 8760866018} 
%%% Social
\email{saranya91velusamy@gmail.com}
%\homepage{www.posquit0.com}
\github{GalanthusPlicatus}
%\linkedin{posquit0}
%%% Optionals
